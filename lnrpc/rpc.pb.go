...
type LightningClient interface {
	...
	ConnectExternalInvoiceGenerator(ctx context.Context, opts ...grpc.CallOption) (Lightning_ConnectExternalInvoiceGeneratorClient, error)
}
...
func (c *lightningClient) ConnectExternalInvoiceGenerator(ctx context.Context, opts ...grpc.CallOption) (Lightning_ConnectExternalInvoiceGeneratorClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Lightning_serviceDesc.Streams[5], c.cc, "/lnrpc.Lightning/ConnectExternalInvoiceGenerator", opts...)
	if err != nil {
		return nil, err
	}
	x := &lightningConnectExternalInvoiceGeneratorClient{stream}
	return x, nil
}

type Lightning_ConnectExternalInvoiceGeneratorClient interface {
	Send(*Invoice) error
	Recv() (*PaymentHash, error)
	grpc.ClientStream
}

type lightningConnectExternalInvoiceGeneratorClient struct {
	grpc.ClientStream
}

func (x *lightningConnectExternalInvoiceGeneratorClient) Send(m *Invoice) error {
	return x.ClientStream.SendMsg(m)
}

func (x *lightningConnectExternalInvoiceGeneratorClient) Recv() (*PaymentHash, error) {
	m := new(PaymentHash)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type LightningServer interface {
	...
	ConnectExternalInvoiceGenerator(Lightning_ConnectExternalInvoiceGeneratorServer) error
}
...
func _Lightning_ConnectExternalInvoiceGenerator_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(LightningServer).ConnectExternalInvoiceGenerator(&lightningConnectExternalInvoiceGeneratorServer{stream})
}

type Lightning_ConnectExternalInvoiceGeneratorServer interface {
	Send(*PaymentHash) error
	Recv() (*Invoice, error)
	grpc.ServerStream
}

type lightningConnectExternalInvoiceGeneratorServer struct {
	grpc.ServerStream
}

func (x *lightningConnectExternalInvoiceGeneratorServer) Send(m *PaymentHash) error {
	return x.ServerStream.SendMsg(m)
}

func (x *lightningConnectExternalInvoiceGeneratorServer) Recv() (*Invoice, error) {
	m := new(Invoice)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var _Lightning_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "ConnectExternalInvoiceGenerator",
			Handler:       _Lightning_ConnectExternalInvoiceGenerator_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
...
var fileDescriptor0 = []byte{
	...
	,
}
