...
It has these top-level messages:
	...
	DeleteRoutingTableRequest
	DeleteRoutingTableResponse
	GetNetworkInfoRequest
	GetNetworkInfoResponse
	DeleteNetworkInfoRequest
	DeleteNetworkInfoResponse
	SearchNetworkInfoRequest
	SearchNetworkInfoResponse
*/
package lnrpc
...
type CloseChannelRequest struct {
	...
	AllowForceClose bool          `protobuf:"varint,3,opt,name=allow_force_close,json=allowForceClose" json:"allow_force_close,omitempty"`
}
...
type CloseStatusUpdate_ChanClose struct {
	ChanClose *ChannelCloseUpdate `protobuf:"bytes,2,opt,name=chan_close,json=chanClose,oneof"`
}
...
type OpenStatusUpdate_ChanOpen struct {
	ChanOpen *ChannelOpenUpdate `protobuf:"bytes,2,opt,name=chan_open,json=chanOpen,oneof"`
}
...
type DeleteRoutingTableRequest struct {
}

func (m *DeleteRoutingTableRequest) Reset()                    { *m = DeleteRoutingTableRequest{} }
func (m *DeleteRoutingTableRequest) String() string            { return proto.CompactTextString(m) }
func (*DeleteRoutingTableRequest) ProtoMessage()               {}
func (*DeleteRoutingTableRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{32} }

type DeleteRoutingTableResponse struct {
}

func (m *DeleteRoutingTableResponse) Reset()                    { *m = DeleteRoutingTableResponse{} }
func (m *DeleteRoutingTableResponse) String() string            { return proto.CompactTextString(m) }
func (*DeleteRoutingTableResponse) ProtoMessage()               {}
func (*DeleteRoutingTableResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{33} }
...
func (*GetNetworkInfoRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{34} }
...
func (*GetNetworkInfoResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{35} }

func (m *GetNetworkInfoResponse) GetInfo() map[string]string {
	if m != nil {
		return m.Info
	}
	return nil
...
type DeleteNetworkInfoRequest struct {
}

func (m *DeleteNetworkInfoRequest) Reset()                    { *m = DeleteNetworkInfoRequest{} }
func (m *DeleteNetworkInfoRequest) String() string            { return proto.CompactTextString(m) }
func (*DeleteNetworkInfoRequest) ProtoMessage()               {}
func (*DeleteNetworkInfoRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{36} }

type DeleteNetworkInfoResponse struct {
}

func (m *DeleteNetworkInfoResponse) Reset()                    { *m = DeleteNetworkInfoResponse{} }
func (m *DeleteNetworkInfoResponse) String() string            { return proto.CompactTextString(m) }
func (*DeleteNetworkInfoResponse) ProtoMessage()               {}
func (*DeleteNetworkInfoResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{37} }

type SearchNetworkInfoRequest struct {
}

func (m *SearchNetworkInfoRequest) Reset()                    { *m = SearchNetworkInfoRequest{} }
func (m *SearchNetworkInfoRequest) String() string            { return proto.CompactTextString(m) }
func (*SearchNetworkInfoRequest) ProtoMessage()               {}
func (*SearchNetworkInfoRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{38} }

type SearchNetworkInfoResponse struct {
}

func (m *SearchNetworkInfoResponse) Reset()                    { *m = SearchNetworkInfoResponse{} }
func (m *SearchNetworkInfoResponse) String() string            { return proto.CompactTextString(m) }
func (*SearchNetworkInfoResponse) ProtoMessage()               {}
func (*SearchNetworkInfoResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{39} }
...
func init() {
	...
	proto.RegisterType((*DeleteRoutingTableRequest)(nil), "lnrpc.DeleteRoutingTableRequest")
	proto.RegisterType((*DeleteRoutingTableResponse)(nil), "lnrpc.DeleteRoutingTableResponse")
	...
	proto.RegisterType((*DeleteNetworkInfoRequest)(nil), "lnrpc.DeleteNetworkInfoRequest")
	proto.RegisterType((*DeleteNetworkInfoResponse)(nil), "lnrpc.DeleteNetworkInfoResponse")
	proto.RegisterType((*SearchNetworkInfoRequest)(nil), "lnrpc.SearchNetworkInfoRequest")
	proto.RegisterType((*SearchNetworkInfoResponse)(nil), "lnrpc.SearchNetworkInfoResponse")
...
type LightningClient interface {
	...
	DeleteRoutingTable(ctx context.Context, in *DeleteRoutingTableRequest, opts ...grpc.CallOption) (*DeleteRoutingTableResponse, error)
	GetNetworkInfo(ctx context.Context, in *GetNetworkInfoRequest, opts ...grpc.CallOption) (*GetNetworkInfoResponse, error)
	DeleteNetworkInfo(ctx context.Context, in *DeleteNetworkInfoRequest, opts ...grpc.CallOption) (*DeleteNetworkInfoResponse, error)
	SearchNetworkInfo(ctx context.Context, in *SearchNetworkInfoRequest, opts ...grpc.CallOption) (*SearchNetworkInfoResponse, error)
}
...
func (c *lightningClient) DeleteRoutingTable(ctx context.Context, in *DeleteRoutingTableRequest, opts ...grpc.CallOption) (*DeleteRoutingTableResponse, error) {
	out := new(DeleteRoutingTableResponse)
	err := grpc.Invoke(ctx, "/lnrpc.Lightning/DeleteRoutingTable", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lightningClient) DeleteNetworkInfo(ctx context.Context, in *DeleteNetworkInfoRequest, opts ...grpc.CallOption) (*DeleteNetworkInfoResponse, error) {
	out := new(DeleteNetworkInfoResponse)
	err := grpc.Invoke(ctx, "/lnrpc.Lightning/DeleteNetworkInfo", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lightningClient) SearchNetworkInfo(ctx context.Context, in *SearchNetworkInfoRequest, opts ...grpc.CallOption) (*SearchNetworkInfoResponse, error) {
	out := new(SearchNetworkInfoResponse)
	err := grpc.Invoke(ctx, "/lnrpc.Lightning/SearchNetworkInfo", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LightningServer interface {
	...
	DeleteRoutingTable(context.Context, *DeleteRoutingTableRequest) (*DeleteRoutingTableResponse, error)
	GetNetworkInfo(context.Context, *GetNetworkInfoRequest) (*GetNetworkInfoResponse, error)
	DeleteNetworkInfo(context.Context, *DeleteNetworkInfoRequest) (*DeleteNetworkInfoResponse, error)
	SearchNetworkInfo(context.Context, *SearchNetworkInfoRequest) (*SearchNetworkInfoResponse, error)
}
...
func _Lightning_DeleteRoutingTable_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteRoutingTableRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LightningServer).DeleteRoutingTable(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lnrpc.Lightning/DeleteRoutingTable",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LightningServer).DeleteRoutingTable(ctx, req.(*DeleteRoutingTableRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Lightning_DeleteNetworkInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteNetworkInfoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LightningServer).DeleteNetworkInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lnrpc.Lightning/DeleteNetworkInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LightningServer).DeleteNetworkInfo(ctx, req.(*DeleteNetworkInfoRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Lightning_SearchNetworkInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SearchNetworkInfoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LightningServer).SearchNetworkInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lnrpc.Lightning/SearchNetworkInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LightningServer).SearchNetworkInfo(ctx, req.(*SearchNetworkInfoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Lightning_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DeleteRoutingTable",
			Handler:    _Lightning_DeleteRoutingTable_Handler,
		},
		{
		...
		},
		{
			...
			Handler:    _Lightning_DeleteNetworkInfo_Handler,
		},
		{
			MethodName: "SearchNetworkInfo",
			Handler:    _Lightning_SearchNetworkInfo_Handler,
		},
	},
...
var fileDescriptor0 = []byte{
	...
	,
}
